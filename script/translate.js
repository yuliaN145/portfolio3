...
let changeLanguage = (dictionary, lang) => {
    for (id in dictionary[lang]) {
        ...
        if (dictionary[lang][id] && element){
            element.innerText =dictionary[lang][id];
...
const btnLangRu = document.querySelector('.button-lang-ru');

btnLangRu.addEventListener('click', function () {
    btnLangRu.classList.toggle('active');
})
